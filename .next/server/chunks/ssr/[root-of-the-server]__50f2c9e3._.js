...
"[project]/app/components/product/productLogic.ts [app-ssr] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/app_components_product_productLogic_ts_5d21cab3._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/app/components/product/productLogic.ts [app-ssr] (ecmascript)");
    });
});
}),
];